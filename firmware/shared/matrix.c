...
volatile const uint8_t MATRIX_GPIOC_PINS[MATRIX_NUM_GPIOC_PINS] = { 
  ...
  MATRIX_GPIOC_2,
  MATRIX_GPIOC_3,
  #if MATRIX_NUM_GPIOC_PINS > 4
  MATRIX_GPIOC_4,
  #endif
  #if MATRIX_NUM_GPIOC_PINS > 5
  MATRIX_GPIOC_5,
  #endif
  #if MATRIX_NUM_GPIOC_PINS > 6
  MATRIX_GPIOC_6,
  #endif
  #if MATRIX_NUM_GPIOC_PINS > 7
  MATRIX_GPIOC_7,
  #endif
};
volatile const uint8_t MATRIX_GPIOD_PINS[MATRIX_NUM_GPIOD_PINS] = {
  ...
  MATRIX_GPIOD_2,
  MATRIX_GPIOD_3,
  #if MATRIX_NUM_GPIOD_PINS > 4
  MATRIX_GPIOD_4,
  #endif
  #if MATRIX_NUM_GPIOD_PINS > 5
  MATRIX_GPIOD_5,
  #endif
  #if MATRIX_NUM_GPIOD_PINS > 6
  MATRIX_GPIOD_6,
  #endif
  #if MATRIX_NUM_GPIOD_PINS > 7
  MATRIX_GPIOD_7,
  #endif
};
